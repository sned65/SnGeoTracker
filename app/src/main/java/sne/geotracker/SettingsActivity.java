...
{
    public static final String PREFERENCE_GENERAL_ACCURACY = "pref_accuracy_threshold";
    public static final String PREFERENCE_GENERAL_MIN_TIME = "pref_min_time";
    public static final String PREFERENCE_GENERAL_MIN_DISTANCE = "pref_min_distance";
    ...
    public boolean onMenuItemSelected(int featureId, MenuItem item)
    {
        ...
        //Log.i(TAG, "onMenuItemSelected() id = "+id+", android.R.id.home = "+android.R.id.home);
        if (id == android.R.id.home)
        {
            //if (!super.onMenuItemSelected(featureId, item)) SN: returns true => navigate() is not called
            //{
            //Log.i(TAG, "onMenuItemSelected() navigateUpFromSameTask");
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment
    {
        ...
        public void onCreate(Bundle savedInstanceState)
        {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference(PREFERENCE_GENERAL_ACCURACY), null);
            bindPreferenceSummaryToValue(findPreference(PREFERENCE_GENERAL_MIN_TIME), null);
            bindPreferenceSummaryToValue(findPreference(PREFERENCE_GENERAL_MIN_DISTANCE), null);
